...
public class RegisterDemoPage  extends PageObject {
    ...
    public static final Target INDICATE_GENDER_MALE = Target.the("Indicate Gender").
            located(By.xpath("//input[@value= 'Male']"));
    public static final Target INDICATE_GENDER_FEMALE = Target.the("Indicate Gender").
            located(By.xpath("//input[@value= 'FeMale']"));
    public static final Target HOBBIES_CRICKET = Target.the("Indicate hobbies").
            located(By.xpath("//input[@value='Cricket']"));
    public static final Target HOBBIES_MOVIES = Target.the("Indicate hobbies").
            located(By.xpath("//input[@value='Movies']"));
    public static final Target HOBBIES_HOCKEY = Target.the("Indicate hobbies").
            located(By.xpath("//input[@value='Hockey']"));
